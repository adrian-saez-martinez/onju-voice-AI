...
const char *OTAhostname = "onju-coral-V3";
...
{
    Serial.begin(115200);
    while (!Serial);  // Wait for Serial Monitor to open (optional, only needed for some boards)
    Serial.println("Starting ESP32-S3...");  // Debug message
